    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <form name="editChannelForm" id="editChannelForm" action="{{ url('admin/channel-update/'.$itemdata->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="token" id="token" value="{{$itemdata->token}}">
                                </div>
                            </div>
                                <!-- -->
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="token_type" id="token_type" class="form-control select2" style="width: 100%;">
                                        <option disabled selected value>Select an --option</option>
                                            @foreach($tokentype as $tkntyp)
                                        <option value="{{$tkntyp->id}}" <?php if($tkntyp->id==$itemdata->token_type){
                                            echo "selected"; } ?> > {{$tkntyp->token_name}} </option>
                                            @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="user_agent" id="user_agent" value="{{$itemdata->user_agent}}" >
                                </div>
                            </div>
                                <!-- -->
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="agent_type" id="agent_type" class="form-control select2" style="width: 100%;">
                                        <option disabled selected value>Select an --option</option>
                                            @foreach($agenttype as $agntype)
                                        <option value="{{$agntype->id}}" <?php if($agntype->id==$itemdata->agent_type){
                                            echo "selected";} ?> > {{$agntype->agent_name}} </option>
                                            @endforeach
                                    </select>
                                </div>
                            </div>
